<?php
/**
 * GitHub Auto-Update for Gumroad Connect Plugin
 * 
...
$github_repo_name  = 'gumroad-connect';
$plugin_slug       = 'gumroad-connect';
$plugin_file       = 'gumroad-connect/gumroad-connect.php';

/**
 * Check for Plugin Updates from GitHub
 */
add_filter('pre_set_site_transient_update_plugins', 'gumroad_connect_check_github_update');
function gumroad_connect_check_github_update($transient) {
 ...
 */
add_filter('plugins_api', 'gumroad_connect_plugin_info_from_github', 10, 3);
function gumroad_connect_plugin_info_from_github($result, $action, $args) {
    global $github_repo_owner, $github_repo_name, $plugin_slug, $plugin_file;
    ...
    $changelog = !empty($release_data->body) 
        ...
        : __('See GitHub release notes for details.', 'gumroad-connect');
    ...
    $result = (object) array(
        ...
        'sections'      => array(
            'description' => $plugin_data['Description'] ?? __('Connect your WordPress site with Gumroad.', 'gumroad-connect'),
 ...
 */
add_action('admin_footer', 'gumroad_connect_github_redirect_version_link');
function gumroad_connect_github_redirect_version_link() {
    ...
    <script type="text/javascript">
        (function() {
            ...
            const pluginSlug = 'gumroad-connect';
            ...
            function processLinks() {
                ...
                const links = document.querySelectorAll('.plugin-title a, .update-message a, a[aria-label*="Gumroad Connect"]');
